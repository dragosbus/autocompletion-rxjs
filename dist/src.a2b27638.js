...
var config = {
  API_KEY: "cd8616dd1859d5e422a87d51ad82a0b9"
};
var _default = config;
...
var API_KEY = _config.default.API_KEY;

var getMovies = function getMovies(query) {
  return fetch("https://api.themoviedb.org/3/search/movie?api_key=".concat(API_KEY, "&language=en-US&query=").concat(query, "&page=1&include_adult=false")).then(function (res) {
    return res.json();
  });
};

var sugestion = document.querySelector(".sugestions");
var searchInput = document.getElementById("search");

var addSugestion = function addSugestion(data) {
...
var getData$ = (0, _rxjs.fromEvent)(searchInput, "input").pipe((0, _operators.throttleTime)(1000), (0, _operators.map)(function (key) {
  return (0, _rxjs.from)(getMovies(key.target.value)).pipe((0, _operators.filter)(function (res) {
    return res;
  }), (0, _operators.map)(function (results) {
...
},{"./config":"src/config.js","rxjs":"node_modules/rxjs/_esm5/index.js","rxjs/operators":"node_modules/rxjs/_esm5/operators/index.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
